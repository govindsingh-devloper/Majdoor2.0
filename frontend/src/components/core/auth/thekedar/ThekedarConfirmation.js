...
//   const { thekedarId, title, location: confirmationLocation } = location.state || { thekedarId: '', title: '', location: '' };
//   console.log("Thekedar ID",thekedarId)
    ...
    <main className="bg-white shadow-md rounded-lg p-6 max-w-4xl mx-auto mt-6">
        ...
        <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex flex-col">
                <span className="font-semibold">ThekedarID</span>
      ...
      <form onSubmit={handleOnSubmit} className="space-y-4">
        ...
        />
          ...
          <div className="flex flex-col">
            <label htmlFor="street" className="font-semibold">ThekedarId:</label>
            <input
              type="text"
              id="street"
              className="border rounded p-2"
